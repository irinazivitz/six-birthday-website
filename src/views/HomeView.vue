<template>
  <div >
    <img src="../assets/InviteFinal.jpg" alt="Invite_image" class="hero-image" />
    
    <button class="rsvp-button" @click="showRSVP = true">RSVP Now</button>
